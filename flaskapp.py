...
#Setup engine using automap from our precompiled database
...
#Same data as collected from Pandas can use similar code
...
def stations():
    ...
    stations = []
    for station,name,lat,lon,elv in queryresult:
        station_dict = {}
